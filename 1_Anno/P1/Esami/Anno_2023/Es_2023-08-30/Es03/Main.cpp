...
bool trovaIlPianetaDiPartenza_rec(int& identificativoPianetaDiPartenza, int carburanteCorrente, int numeroDiPianeti, int tentativi) {
    ...
    //              (per esempio, la variabile "identificativoPianetaDiPartenza" ha un valore apposito)
    else if (identificativoPianetaCorrente != identificativoPianetaDiPartenza) {
        ...
        carburanteCorrente+=carburantePianetaCorrente;
        if(carburantePianetaCorrente < distanzaPianetaCorrente){
            return 0;
        }else{
            ...
            if(trovaIlPianetaDiPartenza_rec(identificativoPianetaDiPartenza, carburanteCorrente, numeroDiPianeti, tentativi+1)){
                return 1;
            }else{
                ...
                enqueue(identificativoPianetaCorrente, carburantePianetaCorrente, distanzaPianetaCorrente);
                carburanteCorrente+=carburantePianetaCorrente;
                return trovaIlPianetaDiPartenza_rec(identificativoPianetaDiPartenza, carburanteCorrente, numeroDiPianeti, tentativi+1);
            }
        }
    }
    ...
    // INDUZIONE 2: l'astronave sta viaggiando da un pianeta all'altro
        ...
        //    ricordandone il valore di ritorno
        return trovaIlPianetaDiPartenza_rec(identificativoPianetaDiPartenza, carburanteCorrente, numeroDiPianeti, tentativi+1) && carburanteCorrente>=0;

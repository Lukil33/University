...
void cerca_percorso(int matrix[][5]);
...
void risolviLabirinto(int matrix[][5], int colonne, int righe){
    init();
    cella partenza;
    partenza.indiceColonna=0;
    partenza.indiceRiga=0;
    push(partenza);
    cerca_percorso(matrix);
}

void cerca_percorso(int matrix[][5], int colonne, int righe){
    int col=
}
...
int trovaIlPianetaDiPartenza(int numeroDiPianeti) {
    ...
    // Per esempio:
    int identificativoPianetaDiPartenza = 69;   // E' possibile inizializzare con un valore apposito
...
bool trovaIlPianetaDiPartenza_rec(int& identificativoPianetaDiPartenza, int carburanteCorrente, int numeroDiPianeti, int tentativi) {
    ...
    //              (per esempio, la variabile "identificativoPianetaDiPartenza" ha un valore apposito)
    else if (identificativoPianetaDiPartenza == 69) {
        ...
        carburanteCorrente+=carburantePianetaCorrente;
        bool carburantesufficiente = true;
        if(distanzaPianetaCorrente > carburanteCorrente){
            carburantesufficiente = false;
        }
        ...
        bool pianetatrovato = trovaIlPianetaDiPartenza_rec(identificativoPianetaDiPartenza, carburanteCorrente, numeroDiPianeti, tentativi);
        ...
        if(!pianetatrovato || !pianetatrovato){
            identificativoPianetaDiPartenza = 69;
            enqueue(identificativoPianetaCorrente, carburantePianetaCorrente, distanzaPianetaCorrente);
            dequeue();
            trovaIlPianetaDiPartenza_rec(identificativoPianetaDiPartenza, 1, numeroDiPianeti, tentativi+1);
        }
    }
    ...
    // INDUZIONE 2: l'astronave sta viaggiando da un pianeta all'altro
        ...
        return carburantesufficiente && pianetatrovato;
    }
}
